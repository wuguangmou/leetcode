...
public class ValidParentheses_020 {
    ...
    /**
     * 括号匹配解决的方法一般都是用栈来解决，这里也是一样，首先用栈来实现。<br/>
    ...
    /**
     * 基于方案二的思想，可以发现：正确的字符串中，总能够剔除一个匹配的括号，直至整个字符串全部为空，因此代码还可以再简化。<br/>
